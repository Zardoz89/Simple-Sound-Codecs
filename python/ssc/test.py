...
class Dm2linBadInput(unittest.TestCase):
    ...
    def test_missing_input(self):
        ...
        self.assertRaises(Exception, dm.dm2lin, None, 1)

    
    def test_invalid_width(self):
        '''dm2lin should fail with invalid width'''
        self.assertRaises(Exception, dm.dm2lin, self.test_data, 0)
        self.assertRaises(Exception, dm.dm2lin, self.test_data, -1)
        self.assertRaises(Exception, dm.dm2lin, self.test_data, 40)
        self.assertRaises(Exception, dm.dm2lin, self.test_data, '4')
        self.assertRaises(Exception, dm.dm2lin, self.test_data, None)
        

    def test_invalid_a(self):
        '''dm2lin should fail with invalid A value'''
        self.assertRaises(Exception, dm.dm2lin, self.test_data, 1, a_cte=-0.5)
        self.assertRaises(Exception, dm.dm2lin, self.test_data, 1, a_cte=1.5)
        self.assertRaises(Exception, dm.dm2lin, self.test_data, 1, a_cte=0)
        self.assertRaises(Exception, dm.dm2lin, self.test_data, 1, a_cte=-2)
        self.assertRaises(Exception, dm.dm2lin, self.test_data, 1, a_cte='0.5')
        self.assertRaises(Exception, dm.dm2lin, self.test_data, 1, a_cte=None)


    def test_invalid_delta(self):
        '''dm2lin should fail with invalid Delta value'''
        self.assertRaises(Exception, dm.dm2lin, self.test_data, 1, delta=0)
        self.assertRaises(Exception, dm.dm2lin, self.test_data, 1, delta=-1)
        self.assertRaises(Exception, dm.dm2lin, self.test_data, 1, delta='32')
        self.assertRaises(Exception, dm.dm2lin, self.test_data, 1, delta=MAX_8)
        self.assertRaises(Exception, dm.dm2lin, self.test_data, 2, delta=MAX_16)
        self.assertRaises(Exception, dm.dm2lin, self.test_data, 4, delta=MAX_32)
...
class lin2btcBadInput(unittest.TestCase):
    ...
    def test_missing_input(self):
        ...
        self.assertRaises(Exception, btc.lin2btc, None, 1, 21)


    def test_invalid_width(self):
        '''lin2btc should fail with invalid width'''
        self.assertRaises(Exception, btc.lin2btc, self.test_data8, 0, 21)
        self.assertRaises(Exception, btc.lin2btc, self.test_data8, -1, 21)
        self.assertRaises(Exception, btc.lin2btc, self.test_data8, 40, 21)
        self.assertRaises(Exception, btc.lin2btc, self.test_data8, '4', 21)
        self.assertRaises(Exception, btc.lin2btc, self.test_data8, None, 21)
        

    def test_invalid_soft(self):
        '''lin2btc should fail with invalid soft value'''
        self.assertRaises(Exception, btc.lin2btc, self.test_data8, 1, 1)
        self.assertRaises(Exception, btc.lin2btc, self.test_data8, 1, -2)
        self.assertRaises(Exception, btc.lin2btc, self.test_data8, 1, '16')
        self.assertRaises(Exception, btc.lin2btc, self.test_data8, 1, None)
...
class Btc2linBadInput(unittest.TestCase):
    ...
    def test_missing_input(self):
        ...
        self.assertRaises(Exception, btc.btc2lin, None, 1, 21)

    
    def test_invalid_width(self):
        '''btc2lin should fail with invalid width'''
        self.assertRaises(Exception, btc.btc2lin, self.test_data, 0, 21)
        self.assertRaises(Exception, btc.btc2lin, self.test_data, -1, 21)
        self.assertRaises(Exception, btc.btc2lin, self.test_data, 40, 21)
        self.assertRaises(Exception, btc.btc2lin, self.test_data, '4', 21)
        self.assertRaises(Exception, btc.btc2lin, self.test_data, None, 21)
        

    def test_invalid_soft(self):
        '''btc2lin should fail with invalid A value'''
        self.assertRaises(Exception, btc.btc2lin, self.test_data, 1, 1)
        self.assertRaises(Exception, btc.btc2lin, self.test_data, 1, -2)
        self.assertRaises(Exception, btc.btc2lin, self.test_data, 1, '16')
        self.assertRaises(Exception, btc.btc2lin, self.test_data, 1, None)
...
class Calc_rcBadInput(unittest.TestCase):
    ...
    def test_invalid_bitrate(self):
        ...
        self.assertRaises(Exception, btc.calc_rc, -1, 21)
        self.assertRaises(Exception, btc.calc_rc, 10, 21)
        self.assertRaises(Exception, btc.calc_rc, None, 21)


    def test_invalid_soft(self):
        '''calc_rc should fail with invalid softness constant'''
        self.assertRaises(Exception, btc.calc_rc, TEST_FS, 1)
        self.assertRaises(Exception, btc.calc_rc, TEST_FS, -2)
        self.assertRaises(Exception, btc.calc_rc, TEST_FS, '16')
        self.assertRaises(Exception, btc.calc_rc, TEST_FS, None)

    def test_invalid_cval(self):
        '''calc_rc should fail with invalid capacitor value'''
        self.assertRaises(Exception, btc.calc_rc, TEST_FS, 21, 0)
        self.assertRaises(Exception, btc.calc_rc, TEST_FS, 21, -1)
        self.assertRaises(Exception, btc.calc_rc, TEST_FS, 21, None)
